...
var _unstable_useId = _interopRequireDefault(require("@material-ui/core/utils/unstable_useId"));
...
var TablePagination = /*#__PURE__*/React.forwardRef(function TablePagination(props, ref) {
  var _props$ActionsCompone = props.ActionsComponent,
      ...
      backIconButtonText = _props$backIconButton === void 0 ? 'صفحه قبل' : _props$backIconButton,
      ...
      labelRowsPerPage = _props$labelRowsPerPa === void 0 ? 'اطلاعات در هر صفحه' : _props$labelRowsPerPa,
      nextIconButtonProps = props.nextIconButtonProps,
      _props$nextIconButton = props.nextIconButtonText,
      nextIconButtonText = _props$nextIconButton === void 0 ? 'صفحه بعد' : _props$nextIconButton,
  ...
  _props$rowsPerPageOpt=_props$rowsPerPageOpt.map((opt)=>PersianNumber(opt))
  console.log(_props$rowsPerPageOpt)
